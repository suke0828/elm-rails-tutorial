			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('navbar is-black  is-fixed-top'),
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$viewLink('Help'),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container hero is-medium has-background-light')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('center hero-body')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Welcome to the Sample App')
									])),
								A2(
								$elm$html$Html$h2,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('This is the home page for the '),
										A2(
										$elm$html$Html$a,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('https://railstutorial.jp/')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text('Ruby on Rails Tutorial')
											])),
										$elm$html$Html$text(' sample application')
									])),
								A2(
								$elm$html$Html$a,
								_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('https://rubyonrails.org/')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('assets/images/rails.svg'),
								$elm$html$Html$Attributes$alt('Rails Logo'),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://www.michaelhartl.com/')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Michael Hartl')
									]))
							])),
						A2(
						$elm$html$Html$nav,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('https://news.railstutorial.org/')
													]),
												_List_fromArray(
													[
